...
export default function AddRecomendacao({ navigation }) {
  ...
  const cursos = [
    ...
    {
      label: "Téc. em Desenvolvimento de Sistemas",
      value: "tec.desenvolvimentodesistemas",
    },
  ...
  const livros = [
    { label: "(Selecione)", value: "" },
    {
      label: "O diário de Anne Frank - Anne Frank",
      value: "OdiáriodeAnneFrank(AnneFrank)",
    },
    {
      label: "A garota do lago - Charlie Donlea",
      value: "Agarotadolago(CharlieDonlea)",
    },
    { label: "Verity - Collen Hoover", value: "Verity(CollenHoover)" },
    {
      label: "Heartstopper - Alice Oseman",
      value: "Heartstopper(AliceOseman)",
    },
    {
      label: "Deixada para trás - Charlie Donlea",
      value: "Deixadaparatrás(CharlieDonlea)",
    },
    {
      label: "A revolução dos bichos - George Orwell",
      value: "Arevoluçãodosbichos(GeorgeOrwell)",
    },
    {
      label: "Procure nas cinzas - Charlie Donlea",
      value: "Procurenascinzas(CharlieDonlea)",
    },
  ];
